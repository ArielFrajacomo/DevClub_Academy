...
export default function Button({
    ...
    const variants = {
        ...
        primary: {
            Default: cn(
                'rounded-md font-semibold shadow-sm shadow-black/50',
                'text-black bg-gray-300 dark:text-white',
                'dark:text-black dark:bg-gray-800 dark:text-white',
            ),
            Hover: cn('hover:bg-gray-400', 'dark:hover:bg-gray-700'),
        },
        secondary: {
        ...
        ghost: {
            Default:
                'rounded-full border-gray-300 border border-gray-500 font-semibold',
            Hover: 'hover:bg-blue-600/30 transition-all duration-400 ease-in-out',
        },
        danger: { Default: 'bg-red-600 text-white', Hover: 'hover:bg-red-700' },
        transparent: {
        ...
        <>
            <button
                className={cn(
                    ...
                    onHover ?? variants[variant].Hover,
                    sizes[size],
                    animation,
                    className,
                )}
            ...
            {confirmAction && (
                <Toast
                    ...
                    onCancel={() => setToastVisible(false)}
                />
            )}
        </>
    )
