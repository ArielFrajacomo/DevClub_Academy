...
const router = createBrowserRouter([
    // Created in en-US and pt-BR versions for better accessibility (and SEO)
    {
        ...
        // Simple error element for good practices and training only, i'll have a better one in the final project
        errorElement: (
            <div className="bg-red-600 justify-center items-center flex h-full flex-col gap-4">
                ...
                <div className="text-xs">
                    This is the most simple, and yet aggressive screen I ever
                    seeing hahahaha lmao
                </div>
            </div>
        ),
        children: [
